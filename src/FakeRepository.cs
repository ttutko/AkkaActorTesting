...
namespace AkkaActorTesting
{
    public class FakeRepository
    {
        ...
        public List<(string name, string fileid, string pluginPath, List<KeyValuePair<string, string>> envVars)> GetPlatforms()
        {
            ...
            platforms.Add((name: "myplatform1", fileid: "5cabce0d0b1a3c260c2bff6d", pluginPath: "Program.py", envVars: new List<KeyValuePair<string, string>> { { new KeyValuePair<string, string>("test1", "test1value") } }));
